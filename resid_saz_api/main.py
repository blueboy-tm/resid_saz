...
class Receipt(object):
    ...
    def centerText(self, y: int, text: str, font=None, fill=None):
        ...
        self.draw.text(((self.W-w)/2, y), text, font=font, fill=fill)
    ...
    def make(self):
        ...
        self.centerText(245, eng2fa(self.receiverCard), font=self.medium(26), fill='#7f9797')
        self.centerText(300, eng2fa(f'{self.amount:,} ریال'), font=self.bold(52), fill='#283130')
        self.text(30, 582, eng2fa(self.date), font=self.regular(30), fill=(41,42,44))
        self.text(30, 672, eng2fa(self.sender), font=self.regular(30), fill=(41,42,44))
        self.text(30, 762, 'کارت به کارت', font=self.regular(30), fill=(41,42,44))
        self.text(30, 852, secureText(eng2fa(self.senderCard)), font=self.regular(30), fill=(41,42,44))
        self.text(30, 942, eng2fa(self.code), font=self.regular(30), fill=(41,42,44))
        responce = requests.get(self.bankImage, proxies=None)
        if responce.status_code != 200: return
